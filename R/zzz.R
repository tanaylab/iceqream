.onLoad <- function(libname, pkgname) {
    ...
    globals <- c(".", "A", "atac_freq", "C", "chrom", "clust", "const", "cor", "diff_score", "dist", "e", "end", "feat", "feature", "freq", "freq_roll", "G", "intervalID", "max_beta", "metacell", "motif", "n_hits", "name", "new_clust", "obs_group", "observed", "ord", "pos", "predicted", "response", "s1", "spread", "start", "strand", "tmp_A", "tmp_C", "tmp_G", "tmp_T", "track", "type", "v", "value", "variable", "annot", "atac", "atac_n", "clust_i", "clust_name", "cumw", "d", "distilled", "energy", "ext_pos", "Gene", "geneSymbol", "grp", "i", "id", "intra_cor", "letter_pos", "lpos", "max_pr", "model", "motif1", "nuc", "rename", "size", "start1", "xmax", "xmin", "motif_db")
