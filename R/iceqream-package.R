...
#' @importFrom dplyr select mutate filter slice left_join right_join inner_join anti_join arrange desc  any_of one_of pull group_by slice_max ungroup n_distinct distinct n everything count bind_rows summarise n summarize row_number starts_with add_count case_when lead last sample_n
