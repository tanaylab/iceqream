...
#' @slot stats A data frame with r2 statistics for each trajectory model before and after distillation.
...
setMethod(
    ...
    function(object) {
        cli::cli({
            ...
            cli_ul(c("{.field @stats}: A data frame with r2 statistics for each trajectory model before and after distillation."))
